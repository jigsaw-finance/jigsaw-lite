...
contract StakingManagerForkTest is Test {
    ...
    function setUp() public {
        ...
        ION_POOL = IIonPool(address(new IonPool({ _underlyingAsset: wstETH })));
    ...
    function test_happyPath() public {
        ...
        assertGe(ionBalanceAfterYear, ionBalanceAfterStake, "Wrong balance in ION after a year");
        assertGt(
